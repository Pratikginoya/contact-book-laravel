...
if (isset($_POST['delete']))
{
	...
	if ($_GET['search_text']) 
	{
		header("location:view_contact.php?search_text=Pratik&search=Search");
	}
	else
	{
		header("location:view_contact.php");
...
<body>
	...
	<?php while ($row = mysqli_fetch_assoc($data)) { ?>	
		...
		<tr>
			...
			<td align="center"><a href="view_contact.php?e_id=<?php echo $row['ID']; ?>" class="button">Edit</a> </td>
			<td align="center"><a href="view_contact.php?d_id=<?php echo $row['ID']; ?>" class="button">Delete</a> </td>
		</tr>
	...
	else
	{
		...
		<tr>
			...
			<td colspan="4" align="center" class="pages">
				...
				{
					if ($page_no_search>1) { ?>
						<a href="view_contact.php?search_text=<?php echo $srch_txt; ?>&page_no_s=<?php echo $previous_search; ?>"><?php echo "Previous"; ?></a> &nbsp;&nbsp;
						<?php } 
				} 
				else
				{
				 	if ($page_no>1) { ?>
				 		<a href="view_contact.php?page_no=<?php echo $previous; ?>"><?php echo "Previous"; ?></a> &nbsp;&nbsp;
						<?php } 
				} ?>
				...
				<?php if (isset($_GET['search_text'])) 
				{
					for ($i=1; $i <=$total_page_search; $i++) { ?>
						<a href="view_contact.php?search_text=<?php echo $srch_txt; ?>&page_no_s=<?php echo $i; ?>"><?php echo $i; ?></a> &nbsp;
						<?php } 
				}
				else
				{
					for ($i=1; $i <=$total_page ; $i++) { ?>
						<a href="view_contact.php?page_no=<?php echo $i; ?>"><?php echo $i; ?></a> &nbsp;
						<?php } 
				} ?>
				...
				<?php if (isset($_GET['search_text'])) 
				{
					if ($page_no_search<$total_page_search) { ?>
						<a href="view_contact.php?search_text=<?php echo $srch_txt; ?>&page_no_s=<?php echo $next_search; ?>"><?php echo "Next"; ?></a>
						<?php }
				}
				else
				{
					if ($page_no<$total_page) { ?>
						<a href="view_contact.php?page_no=<?php echo $next; ?>"><?php echo "Next"; ?></a>
					<?php } 
				} ?>
