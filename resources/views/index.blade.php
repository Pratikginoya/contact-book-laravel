...
<head>
	...
	<title>Log In</title>
	<link rel="stylesheet" type="text/css" href="{{URL::asset('css/website_login.css') }}">
</head>
<body>
<table>
	<tr>
		...
		<td>
			<div class="classC">
				...
				<table>
					...
					<tr>
						<td colspan="2" height="30" align="center"><a href="/register" class="fontC">Register Now</a></td>
					</tr>
