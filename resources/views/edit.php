...
<form method="post">
	<table class="div1" border="0">
		...
		<tr>
			...
			<td><input type="password" name="password" placeholder="Enter Password (5 to 10 digit)" minlength="5" maxlength="10" size="35" class="input" value="<?php echo @$row['Password']; ?>" required></td>
		</tr>
		...
		<tr>
			...
			<td><input type="password" name="password2" placeholder="Re-Enter Password (5 to 10 digit)" minlength="5" maxlength="10" size="35" class="input" value="<?php echo @$row['Password']; ?>" required></td>
		</tr>
