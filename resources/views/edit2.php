...
<form method="post">
	<table class="div1" border="0">
		...
		<tr>
			<td colspan="2" class="fontE">&nbsp; Re-entered password is not match...! &nbsp;&nbsp; Please Enter Same Password in Both... </td>
		</tr>
		...
		<tr>
			...
			<td><input type="name" name="name" placeholder="Name" size="35" class="input" value="<?php echo @$row['Name']; ?>" required></td>
		</tr>
		...
		<tr>
			<td class="inputB">Password : </td>
			<td><input type="password" name="password" placeholder="Enter Password (5 to 10 digit)" minlength="5" maxlength="10" size="35" class="input" required></td>
		</tr>

		<tr><td width="350" height="10"><br></td></tr>

		<tr>
			<td class="inputB">Re-Enter Password : </td>
			<td><input type="password" name="password2" placeholder="Re-Enter Password (5 to 10 digit)" minlength="5" maxlength="10" size="35" class="input" required></td>
		</tr>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" name="save" value="Submit" class="button"><a href="website_home.php" class="button">Back to Home</a></td>
		</tr>
